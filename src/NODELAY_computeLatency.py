...
# - It calls "extractAllOnsetsMod.sh" with those parameters, which calls aubioonset
...
EXT_RES = os.popen("./utility_scripts/extractAllOnsetsMod.sh " + opts).read()
...
# Note: in this modded version there is no delay to add
AUBIODELAY_SAMPLES = 0.0 #int(re.search('[0-9]+', PARTIAL_STRING).group(0))

print("The delay introduced by MODDED aubioonset is " + str(AUBIODELAY_SAMPLES) + " samples")
SAMPLE_RATE = 48000
