...
# NOTE!!!
#
# This script calls a modified version of aubio onset
# Disregard following comments
#
# Note that this mod version prints directly the time when onset is detected
#
...
aubioonsetmod="/home/domenico/Desktop/CustomAubio/aubio/build/examples/aubioonset"
...
$aubioonsetmod $fullfilename -B $BUFFER_SIZE -H $HOP_SIZE -s $SILENCE_THRESHOLD -t $ONSET_THRESHOLD -O $ONSET_METHOD -M $MINIMUM_INTER_ONSET_INTERVAL_SECONDS > $subdir$filename.txt
